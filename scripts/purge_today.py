...
browser approval.
    ...
    uv run --with 'mcp>=2,<3' python scripts/purge_today.py --since 2026-06-09           # dry-run
    uv run --with 'mcp>=2,<3' python scripts/purge_today.py --since 2026-06-09 --execute # delete
"""
