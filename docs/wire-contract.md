...
Claude per-turn capture supports multiple active destinations. Claude SessionEnd/
commit/PR backstop, Codex and Cursor still require one destination until their
