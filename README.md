...
Claude per-turn and SessionEnd/commit/PR backstop capture deliver independently
to active local and cloud destinations without changing cloud-service
authentication. Codex and Cursor currently require one active destination.
